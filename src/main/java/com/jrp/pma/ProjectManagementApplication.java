...
@SpringBootApplication(scanBasePackages={"com.jrp.pma","com.jrp.utills","com.jrp.utills"})
...
//		return args -> {
//			
//			Employee emp1 = new Employee("John", "Warton", "john@warton.com");
...
//			
//			
//			Project pro1 = new Project("Large Production Deploy", "NOTSTARTED", "This require all hands on deck for"
...
//			
//			
//			// need to set both sides relationship mannually
